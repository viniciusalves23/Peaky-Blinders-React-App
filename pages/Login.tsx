...
import { Scissors, ChevronLeft, Eye, EyeOff, AlertTriangle, CheckCircle2 } from "lucide-react"
...
export const Login: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (emailConfirmed === "true") {
      setSuccess("Email validado com sucesso. Favor realizar login.")
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 py-8 animate-fade-in relative">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
        {success && (
          <div className="p-4 bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 text-green-600 dark:text-green-400 text-xs rounded-xl flex items-start gap-2">
        ...
        <div className="text-right">
          <Link to="/forgot-password" className="text-xs font-bold text-zinc-400 hover:text-gold-600 transition-colors">
            Esqueci minha senha
          </Link>
        </div>
